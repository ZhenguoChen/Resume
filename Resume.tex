...
\address{Phone: (303) 359-7579 \ email:  \href{mailto:Zhenguo.Chen@colorado.edu}{Zhenguo.Chen@colorado.edu}} % Your phone number and email
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
 Skills \ & Python, C++, AWS, Data Structure, Algorithm, TensorFlow, Django, Docker, Vue \\
\end{tabular}
